...
-- ============================================================
-- MODULE TEMPS ET PRESENCE ENTERPRISE
-- ============================================================
...
INSERT INTO permissions (name, module) VALUES
  ...
  ('time:read', 'time'), ('time:write', 'time'),
  ('time:configure', 'time'), ('time:input', 'time'),
  ('time:calculate', 'time'), ('time:validate', 'time'),
  ('time:export', 'time'), ('time:import', 'time'),
