...
export class SeedService implements OnApplicationBootstrap {
  ...
  private async seedPermissions() {
    const modules = {
      ...
      time: ['read', 'write', 'configure', 'input', 'calculate', 'validate', 'export', 'import'],
  ...
  private async seedRoles() {
    ...
    const roleDefs = [
      ...
      { name: 'supervisor', description: 'Superviseur', perms: ['employees:read', 'contracts:read', 'payroll:read', 'time:read', 'time:validate', 'leave:read', 'reports:read', 'settings:read'] },
      { name: 'agent', description: 'Agent', perms: ['employees:read', 'employees:write', 'leave:read', 'leave:write'] },
      { name: 'company', description: 'Entreprise', perms: ['employees:read', 'contracts:read', 'payroll:read', 'time:read', 'leave:read', 'reports:read', 'settings:read'] },
      { name: 'support_tech', description: 'Support Technique', perms: ['users:read', 'companies:read', 'settings:read', 'audit:read'] },
      { name: 'rh_manager', description: 'Responsable RH', perms: ['employees:read', 'employees:write', 'leave:read', 'leave:write', 'leave:approve', 'time:read', 'time:write', 'time:configure', 'time:input', 'time:calculate', 'time:validate', 'time:export', 'time:import', 'contracts:read', 'reports:read', 'audit:read', 'audit:write'] },
      {
        name: 'accountant',
